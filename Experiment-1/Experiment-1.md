# SQL Intermediate - Insert Data and Retrieve First Records
...
```sql
-- Complete the queries below to insert data into the tables & retrieve the first records from the first 3 tables.
...
-- Retrieve the first record from Doctors table
SELECT * FROM Doctors LIMIT 1;

-- Retrieve the first record from Patients table
SELECT * FROM Patients LIMIT 1;

-- Retrieve the first record from Appointments table
